...
class StatesTable:
    def __init__ (self):
        ...
        self.second_bypasser_program = {
            ...
            ("q999",frozenset({"s", "e"})) : ["right", "q11"], # new 2 (6-е поколение)
            ...
            ("q103",frozenset({"w", "n", "s", "e"})) : ["left", "q14"], # new 2 (4-е поколение)
            ...
            ("q19",frozenset({"s", "w"})) : ["down", "q18"],
            ("q19",frozenset({"s", "w", "e", "n"})) : ["up", "q11"],
        }
        ...
        self.inverted_fifth_bypasser_program = {
